...
// //             {/* Content Section */}
// //             <div className="flex flex-col justify-between items-center gap-5 z-10 text-center px-6 sm:px-12  font-sigmar font-extrabold uppercase">
// //                 <h2 className="text-4xl sm:text-6xl font-bold leading-tight">
// //                     Download Now
// //                     <span className="block text-3xl sm:text-5xl mt-2">Lorem Ipsum</span>
// //                 </h2>

// //                 <Link to="/" className="inline-flex items-center gap-2 px-6 py-3 text-lg font-medium bg-orange-700 text-white rounded-lg shadow-lg hover:bg-orange-800 transition">
...
// //                 <img className="w-44 h-40 rounded-full" src="./Images/avatar.png" alt="image2"  />
// //             </div> */}

// //             {/* Footer Heading */}
// //             {/* <h1 className="relative z-10 text-center text-2xl sm:text-4xl font-medium mt-10">
// //                 Lorem Ipsum Yojo
// //             </h1> */}
// //         </div>
// //     );
...
//                     <span className="block text-3xl sm:text-5xl mt-2">I'M ISRA ILYAS</span>
//                 </h2>
                
//                 <p className="text-lg sm:text-xl font-medium max-w-2xl mt-2">
//                     Passionate Frontend Developer | Python Enthusiast | SEO Expert
//                 </p>

//                 <Link to="/projects" className="inline-flex items-center gap-2 px-6 py-3 text-lg font-medium bg-orange-700 text-white rounded-lg shadow-lg hover:bg-orange-800 transition">
//                     <IoLogoGooglePlaystore className="w-8 h-8 text-white" />
